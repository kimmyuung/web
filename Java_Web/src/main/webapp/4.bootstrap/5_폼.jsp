...
<body>
	...
	<form>
		<label> </label> <input type="text" placeholder="이름"> <label>
		</label> <input type="email" placeholder="이메일">
	...
	<div class="container row"> <!-- 클래스명1 클래스명2 클래스명3 클래스명 여러개 가능 -->
	...
	<div class="container">
	<div class="row">
	<div class="col-md-3"> <img alt="" src="강아지.jpg" width="100%">  </div>
	<div class="col-md-3"> <img alt="" src="강아지.jpg" width="100%">  </div>
	<div class="col-md-3"> <img alt="" src="강아지.jpg" width="100%">  </div>
	<div class="col-md-3"> <img alt="" src="강아지.jpg" width="100%">  </div>
	</div>
